...
<section class="content">
    <div class="container-fluid">
        <h5 class="mb-2">Singapore Traveller Information</h5>
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title" >Singapore Traveller Information </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                             @forelse($total_traveller as $v_traveller)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/admin-Singapore-traveller-verification')}}/{{$v_traveller->id}}">{{$v_traveller->user_info_traveller->name}}</a>
                                    </td>
                                    ...
                                    <td>  
                                        ...
                                        <b style="colorblue"><a href="{{url('/admin-Singapore-traveller-verification')}}/{{$v_traveller->id}}"> Verified Checking</a></b>
                                      @else
                                      <b style="color:red">Unverified</b>
                                    ...
                                    <td> @if($v_traveller->video_verification)
                                        ...
                                        <b style="color:#a839d6"><a href="{{url('/admin-Singapore-traveller-verification')}}/{{$v_traveller->id}}"> Verified Checking</a></b>
                                      @else
                                      <b style="color:red">Unverified</b>
                                    ...
                                    <td>
                                     ...
                                     @if($v_traveller->status==1)
                                        <button type="button" style=" color:white ;background-color:green"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-Singapore-traveller-status')}}/{{$v_traveller->status}}/{{$v_traveller->id}}">Active</a>
                                            </button>
                                      @else
                                            <button type="button" style=" color:white ;background-color:#8b60ed"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-Singapore-traveller-status')}}/{{$v_traveller->status}}/{{$v_traveller->id}}">Inactive</a>
                                            </button>
                                            @endif
                                            ...
                                            <button type="button" style="color:white  ;background-color:red"
                                                class="btn "><a style="color:white"
                                                    href="{{url('/admin-Singapore-traveller-delete')}}/{{$v_traveller->id}}">
                                                    Delete</a></button>
                                        </div> 
                                    </td>
                                </tr>
