                            ...
                            <tbody>
                             @forelse($total_user as $v_user)
                                <tr>
                                    <td>{{$v_user->id}}</td>
                                    <td>
                                        <a href="{{url('/admin-pak-user-info')}}/{{$v_user->id}}">{{$v_user->name}}</a>
                                    </td>
                                    ...
                                    <td>
                                    <img src="{{asset('profile_image/pak_profile/profile_image')}}/{{$v_user->profile_image}}"
                                    ...
                                    <td>
                                     ...
                                     @if($v_user->status==1)
                                        <button type="button" style=" color:white ;background-color:green"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-pak-user-status')}}/{{$v_user->status}}/{{$v_user->id}}">Active</a>
                                            </button>
                                      @else
                                            <button type="button" style=" color:white ;background-color:#8b60ed"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-pak-user-status')}}/{{$v_user->status}}/{{$v_user->id}}">Inactive</a>
                                            </button>
                                            @endif
                                            ...
                                            <button type="button" style="color:white  ;background-color:red"
                                                class="btn "><a style="color:white"
                                                    href="{{url('/admin-pak-user-delete')}}/{{$v_user->id}}">
                                                    Delete</a></button>
                                        </div> 
                                    </td>
                                </tr>
