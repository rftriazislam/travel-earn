...
<section class="content">
    <div class="container-fluid">
        <h5 class="mb-2">Singapore User Information</h5>
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">singapore User Information </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                             @forelse($total_user as $v_user)
                                <tr>
                                    <td>{{$v_user->id}}</td>
                                    <td>
                                        <a href="{{url('/admin-singapore-user-info')}}/{{$v_user->id}}">{{$v_user->name}}</a>
                                    </td>
                                    ...
                                    <td>
                                    <img src="{{asset('profile_image/singapore_profile/profile_image')}}/{{$v_user->profile_image}}"
                                    ...
                                    <td>
                                     ...
                                     @if($v_user->status==1)
                                        <button type="button" style=" color:white ;background-color:green"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-singapore-user-status')}}/{{$v_user->status}}/{{$v_user->id}}">Active</a>
                                            </button>
                                      @else
                                            <button type="button" style=" color:white ;background-color:#8b60ed"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-singapore-user-status')}}/{{$v_user->status}}/{{$v_user->id}}">Inactive</a>
                                            </button>
                                            @endif
                                            ...
                                            <button type="button" style="color:white  ;background-color:red"
                                                class="btn "><a style="color:white"
                                                    href="{{url('/admin-singapore-user-delete')}}/{{$v_user->id}}">
                                                    Delete</a></button>
                                        </div> 
                                    </td>
                                </tr>
