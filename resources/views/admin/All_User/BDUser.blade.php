                            ...
                            <tbody>
                             @forelse($total_user as $v_user)
                                <tr>
                                    <td>{{$v_user->id}}</td>
                                    <td>
                                        <a href="{{url('/admin-bd-user-info')}}/{{$v_user->id}}">{{$v_user->name}}</a>
                                    </td>
                                    <td>{{$v_user->mobile_number}}</td>
                                    <td>{{$v_user->drop_balance}}  &nbsp;&nbsp;&nbsp;&nbsp;(<a href="{{url('/admin-bd-user-info')}}/{{$v_user->id}}" style="color:red">Add Money</a>)</td>
                                    <td>{{$v_user->product_balance}} </td>
                                    <td>{{$v_user->email}}</td>
                                   
                                    <td>
                                    <img src="{{asset('profile_image/bd_profile/profile_image')}}/{{$v_user->profile_image}}"
                                    ...
                                    <td>
                                     ...
                                     @if($v_user->status==1)
                                        <button type="button" style=" color:white ;background-color:green"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-bd-user-status')}}/{{$v_user->status}}/{{$v_user->id}}">Active</a>
                                            </button>
                                      @else
                                            <button type="button" style=" color:white ;background-color:#8b60ed"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-bd-user-status')}}/{{$v_user->status}}/{{$v_user->id}}">Inactive</a>
                                            </button>
                                            @endif
                                            ...
                                            <button type="button" style="color:white  ;background-color:red"
                                                class="btn "><a style="color:white"
                                                    href="{{url('/admin-bd-user-delete')}}/{{$v_user->id}}">
                                                    Delete</a></button>
                                        </div> 
                                    </td>
                                </tr>
