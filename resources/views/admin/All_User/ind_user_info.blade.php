            ...
            <div class="col-md-3">
                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle"
                                src="{{asset('profile_image/ind_profile/profile_image')}}/{{$ind_user_info->profile_image}}"
                                alt="User profile picture">
                        </div>

                        <h3 class="profile-username text-center">{{$ind_user_info->name}}</h3>

                        <p class="text-muted text-center">User ID:<b style="color:black"> {{$ind_user_info->id}} </b></p>

                        <ul class="list-group list-group-unbordered mb-3">
                            <li class="list-group-item">
                                <b>Country Code:</b> <a class="float-right">{{$ind_user_info->country_code}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Contact Number:</b> <a class="float-right">{{$ind_user_info->mobile_number}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Email:</b> <a class="float-right">{{$ind_user_info->email}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Father's Name</b> <a class="float-right">{{$ind_user_info->father_name}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Mother's Name</b> <a class="float-right">{{$ind_user_info->mother_name}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Balance:</b> <a class="float-right">{{$ind_user_info->balance}}</a>
                            </li>
                            <li class="list-group-item">
                                <b>Total Earn</b> <a class="float-right">{{$ind_user_info->total_earn}}</a>
                            </li>
                            <!-- <li class="list-group-item">
                                <b>Present Address:</b> <a class="float-right">{{$ind_user_info->present_address}}</a>
                            </li> -->
                            <!-- <li class="list-group-item">
                                <b>Permanent Address:</b> <a
                                    class="float-right">{{$ind_user_info->permanent_address}}</a>
                            </li> -->

                            <li class="list-group-item">
                                <b>Mac Id</b> <a class="float-right">{{$ind_user_info->mac_id}}</a>
                            </li>
                        </ul>
                        @if($ind_user_info->status==1)
                        <a href="{{url('/admin-ind-user-status')}}/{{$ind_user_info->status}}/{{$ind_user_info->id}}"
                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted">{{$ind_user_info->present_address}}</p>

                        <hr>
                        <strong><i class="fas fa-map-marker-alt mr-1"></i> Permanent Location</strong>

                        <p class="text-muted">{{$ind_user_info->permanent_address}}</p>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="active tab-pane" id="serviceaccept">
                                <!-- Post -->
                                @foreach($ind_user_info->traveller_info->request_service_info as $request_service_info)
                                <div class="post">
                                    <div class="user-block">
                                        <img class="img-circle img-bordered-sm"
                                            src="{{asset('profile_image/ind_profile/profile_image')}}/{{$request_service_info->user_info->profile_image}}"
                                            alt="user image">
                                        <span class="username">
                                            <a href="{{url('/admin-ind-user-info')}}/{{$request_service_info->user_info->id}}">{{$request_service_info->user_info->name}}</a>
                            ...
                            <div class=" tab-pane" id="services">
                                ...
                                <div class="post">
                                    ...
                                    <div class="user-block">
                                        @foreach($ind_service as $service_info)
                            ...
                            <div class=" tab-pane" id="serviceadd">
                                ...
                                @foreach($ind_user_info->request_service_info as $request_service_info)
                                <div class="post">
                                    <div class="user-block">
                                        <h6><b style="color:#8b60ed">Service Create</b><b>
                                    ...
                                    <div class="user-block">
                                        ...
                                        <div class="col-md-6" style="float:left">
                                            <img class="img-circle img-bordered-sm"
                                                src="{{asset('profile_image/ind_profile/profile_image')}}/{{$request_service_info->traveller_info->user_info_traveller->profile_image}}"
                                                alt="">
                                            <a
                                                href="{{url('/admin-ind-user-info')}}/{{$request_service_info->traveller_info->user_info_traveller->id}}">
                                ...
                                <div class="timeline timeline-inverse">
                                    ...
                                    <div class="time-label">
                                        <span class="bg-danger">
                                            {{$ind_user_info->traveller_info->created_at}}
                                        </span>
                                    </div>
                                    <!-- /.timeline-label -->
                                    <!-- timeline item -->
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                {{$ind_user_info->traveller_info->mobile_verification}}
                                            </div>
                                        </div>
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                {{$ind_user_info->traveller_info->email_verification}}
                                            </div>
                                        </div>
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                {{$ind_user_info->traveller_info->NID_verification}}
                                            </div>
                                        </div>
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                {{$ind_user_info->traveller_info->NID_number}}
                                            </div>
                                        </div>
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                {{$ind_user_info->traveller_info->security_money}}
                                            </div>
                                        </div>
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                {{$ind_user_info->traveller_info->resident_verification}}
                                            </div>
                                        </div>
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                {{$ind_user_info->traveller_info->agent_verification}}
                                            </div>
                                        </div>
                                        <div class="timeline-item">
                                            <h3 class="timeline-header"><a href="#">Sucessfull Delivery Count </a>
                                                {{$ind_user_info->traveller_info->sucessfull_delivery_count}}</h3>
                                            <h3 class="timeline-header"><a href="#">Sucessfull Delivery Count</a>
                                                {{$ind_user_info->traveller_info->sucessfull_delivery_count}}</h3>
                                    ...
                                    <div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                <img src="{{asset('NID_image/ind_NID_image')}}/{{$ind_user_info->traveller_info->NID_image}}"
                                                    alt="...">
                                            </div>
                                        </div>
                                        ...
                                        <div class="timeline-item">
                                            ...
                                            <div class="timeline-body">
                                                <video width="320" height="240" controls>
                                                    <source
                                                        src="{{asset('self_video/ind_self_video')}}/{{$ind_user_info->traveller_info->self_video}}"
                                                        type="video/mp4">
