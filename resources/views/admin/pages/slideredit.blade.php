                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Edit/UpdatedSlider</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" method="post" action="{{route('sliderupdate')}}"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slider_name" class="form-control" value="{{$slideredit->slider_name}}" required php
                                        id="exampleInputEmail1" placeholder="Slider Name ...">
                                        <input type="hidden" name="slider_id" class="form-control" value="{{$slideredit->id}}"   php
                                        id="exampleInputEmail1" placeholder="Slider Name ...">
                                </div>
                                <div class="form-group">
                          ...
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$slideredit->slider_title}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" value="{{$slideredit->slider_image}}"  name="slider_image"
                                                id="exampleInputFile">
                                            <label class="custom-file-label" for="exampleInputFile">slider Select</label>
                                        </div>
                                    ...
                                    <img src="{{asset('back_end/slider_image')}}/{{$slideredit->slider_image}}" height="80px" width="100px">
