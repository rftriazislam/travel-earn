...
<section class="content">
    <div class="container-fluid">
        <h5 class="mb-2">India Service Request Information</h5>
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">India Service  Request Information </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                             @forelse($total_service_request as $v_service_request)
                                <tr>
                                    ...
                                    <td>
                                  <a href="{{url('/admin-ind-user-info')}}/{{$v_service_request->user_info->id}}">        {{ $v_service_request->user_info->name }}   </a> 
                                    </td>
                                    <td>
                                     <a href="{{url('/admin-ind-user-info')}}/{{$v_service_request->traveller_info->user_info_traveller->id}}">   {{ $v_service_request->traveller_info->user_info_traveller->name }} </a> 
                                    </td>
