...
<section class="content">
    <div class="container-fluid">
        <h5 class="mb-2">Indian Agent Information</h5>
        <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Total IND Agent</span>
                        <span class="info-box-number">{{ $total_ind_agent->count() }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $total_ind_agent->where('status',1)->count() }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-12">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $total_ind_agent->where('status',0)->count() }}</span>
                    </div>
                    <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">IND Agent Information </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @forelse($total_ind_agent as $v_agent)
                                <tr>
                                    <td>{{$v_agent->id}}</td>
                                    <td>
                                        <a href="{{url('/admin-IND-agent-info')}}/{{$v_agent->id}}">{{$v_agent->name}}</a>
                                    </td>                                
                                    <td></td>
                                    ...
                                    <td>
                                     ...
                                     @if($v_agent->status==1)
                                        <button type="button" style=" color:white ;background-color:green"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-IND-agent-status')}}/{{$v_agent->status}}/{{$v_agent->id}}">Active</a>
                                            </button>
                                      @else
                                            <button type="button" style=" color:white ;background-color:#8b60ed"
                                                class="btn ">
                                                <a style="color:white"
                                                    href="{{url('/admin-IND-agent-status')}}/{{$v_agent->status}}/{{$v_agent->id}}">Inactive</a>
                                            </button>
                                            @endif
                                            ...
                                            <button type="button" style="color:white  ;background-color:red"
                                                class="btn "><a style="color:white"
                                                    href="{{url('/admin-IND-agent-delete')}}/{{$v_agent->id}}">
                                                    Delete</a></button>
                                        </div> 
                                    </td>
                                </tr>
