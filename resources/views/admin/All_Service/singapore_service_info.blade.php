                          ...
                          <div class="card-body box-profile">
                            <div class="text-center">
                              <img class="profile-user-img img-fluid img-circle"
                                   src="{{asset('profile_image/singapore_profile/profile_image')}}/{{$service_info->service_user_info->profile_image}}"
                                   alt="User profile picture">
                            </div>
            
                            <h3 class="profile-username text-center"><a href="{{url('/admin-bd-user-info')}}/{{$service_info->user_id}}" style="color:chocolate">{{$service_info->service_user_info->name}} </a> </h3>
