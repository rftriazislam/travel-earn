...
<section class="content">
    <div class="container-fluid">
        <h5 class="mb-2">India Service Information</h5>
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">India Service Information </h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                            ...
                            <tbody>
                             @forelse($total_service as $v_service)
                                <tr>
                                    <td>{{$v_service->id}}</td>
                                    <td>
                                    <a href="{{url('/admin-IND-Service-info')}}/{{$v_service->id}}">{{ $v_service->service_user_info->name }}</a>
                                    </td>
                                   
                                    <td>
                                    <img src="{{asset('profile_image/ind_profile/profile_image')}}/{{$v_service->service_user_info->profile_image}}"
